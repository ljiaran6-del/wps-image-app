...
class AIEraseTool(SelectionTool):
    """AI消除工具"""

    def __init__(self, viewer):
        super().__init__(viewer, name="ai_erase")
    ...
    def _build_property_widget(self):
        ...
        layout.addWidget(QLabel("AI消除"))
        layout.addWidget(QLabel("在图片上涂抹或框选要消除的区域，然后点击开始。"))
        ...
        self.btn_process = QPushButton("开始消除")
