from PySide6.QtWidgets import (
    ...
    QSlider, QHBoxLayout, QButtonGroup
)
...
class AIWatermarkTool(SelectionTool):
    """AI去水印工具"""

    def __init__(self, viewer):
        super().__init__(viewer, name="ai_watermark")
    ...
    def _build_property_widget(self):
        ...
        layout.addWidget(QLabel("AI去水印"))
        layout.addWidget(QLabel("涂抹或框选水印区域，然后点击开始去除。"))
        ...
        self.btn_process = QPushButton("开始去水印")
